...
const SharedCollection = () => {
  ...
  const handleSaveCollection = async () => {
    ...
    try {
      ...
      const response = await api.post(`/collections/share/${token}/save`);
      
      setSaveMessage(`Collection and all ${response.data.records_saved} records saved successfully to your account!`);
      
      // Clear message after 5 seconds (longer for collection save)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <div className="mt-2 text-sm text-blue-700">
                        <p>Sign in to save this entire medical collection and all its records to your personal account for future access.</p>
                      </div>
                      <div className="mt-3">
                        <button
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <div className="mt-2 text-sm text-green-700">
                        <p>Signed in as <strong>{user?.username}</strong>. Save this collection and all {records?.length || 0} records to your personal account.</p>
                      </div>
                      <div className="mt-3">
                        <button
        ...
        <div className="bg-white shadow rounded-lg">          {/* Collection Header */}
