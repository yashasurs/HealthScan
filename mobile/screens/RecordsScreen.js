...
const RecordsScreen = ({ navigation }) => {
  ...
  const getCollectionBadge = (record) => {
    if (record.collection_id) {
      return (
        <View style={styles.collectionBadge}>
          <Ionicons name="folder" size={12} color="#4A90E2" />
          <Text style={styles.collectionBadgeText}>In Collection</Text>
        </View>
      );
    }
    return (
      <View style={styles.noCollectionBadge}>
        <Text style={styles.noCollectionBadgeText}>No Collection</Text>
      </View>
    );
  };
          ...
          <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
            <View style={styles.recordDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>
                  {selectedRecord?.collection_id ? 'In Collection' : 'Not in any collection'}
                </Text>
              </View>
            </View>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          >
            ...
            <Text style={styles.addRecordButtonText}>Upload</Text>
          </TouchableOpacity>
        </View>
